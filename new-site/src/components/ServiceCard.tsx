  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow border border-gray-100">
      <button 
        ...
        className="w-full flex items-center justify-between p-6 text-left focus:outline-none bg-gradient-to-r from-gray-50 to-white hover:from-cyan-50 hover:to-white transition-colors"
      >
